    ...
    <div className="min-h-screen bg-[#FFF8F0] text-[#4A3728]">
      ...
      <section className="relative h-[65vh] flex items-end justify-center pb-20 overflow-hidden">
        ...
        <div 
          ...
          style={{ backgroundImage: `url('/guest.jpg')` }} 
        />
      ...
      <div className="bg-[#FFF1E0] py-6">
        <div className="max-w-7xl mx-auto px-6 text-[13px] text-gray-600 flex gap-2">
          ...
          <span>{'>'}</span> 
          <span className="font-semibold text-[#4A3728]">Hospitality & Guest Services</span>
        </div>
      </div>
      ...
      <section className="max-w-7xl mx-auto px-6 py-12 md:py-20">
        <h2 className="text-3xl md:text-5xl font-serif mb-4 text-[#4A3728]">
            Hospitality & Guest Services– PS Decor
        </h2>
      ...
      <section className="bg-[#fceee5]/50 py-20 border-t border-b border-orange-100/50">
        <div className="max-w-7xl mx-auto px-6">
          <h2 className="text-3xl md:text-4xl font-serif mb-10 text-[#4A3728]">
           Seamless Guest Management Services
          </h2>
          
          <div className="space-y-8 text-lg text-gray-800 max-w-6xl mb-16">
            <p>
           Managing hundreds of guests across multiple functions can be overwhelming, but PS Decor makes it effortless with end-to-end guest management solutions.
            Our dedicated hospitality team coordinates transport arrangements, hotel accommodations, luggage assistance, seating plans, and event flow management. For destination weddings, we provide travel coordination, shuttle services, and round-the-clock support, ensuring that guests enjoy both the journey and the celebrations. Every detail is handled with precision, allowing hosts to relax while we ensure their loved ones are comfortable and well looked after.
           </p>
          </div>
          ...
          <div className="mt-20">
           ...
           Personalized Hospitality Touches
            </h2>
         ...
         <div className="mt-20">
            <h2 className="text-3xl md:text-4xl font-serif mb-8 text-[#4A3728]">
         Luxury Guest Services for Unmatched Comfort
            </h2>
            <p className="text-lg text-gray-800 leading-relaxed max-w-6xl mb-12">
