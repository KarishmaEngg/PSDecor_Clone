    ...
    <div className="min-h-screen bg-[#FFF8F0] text-[#4A3728]">
      ...
      <section className="relative h-[65vh] flex items-end justify-center pb-20 overflow-hidden">
        ...
        <div className="relative z-10 text-center text-white px-4">
          <h1 className="text-4xl md:text-7xl font-serif mb-4 tracking-wide">
            Luxury Wedding Décor & Styling
          </h1>
          <p className="text-xl md:text-2xl italic font-light tracking-widest">
           Creating Timeless Luxury for Your Wedding
          </p>
        </div>
      </section>
      ...
      <section className="max-w-7xl mx-auto px-6 py-12 md:py-20">
        <h2 className="text-3xl md:text-5xl font-serif mb-4 text-[#4A3728]">
         Luxury Wedding Décor & Styling – PS Decor
        </h2>
      ...
      <section className="bg-[#fceee5]/50 py-20 border-t border-b border-orange-100/50">
        <div className="max-w-7xl mx-auto px-6">
          <h2 className="text-3xl md:text-4xl font-serif mb-10 text-[#4A3728]">
            Bespoke Styling That Reflects Your Story
          </h2>
          
          <div className="space-y-8 text-lg text-gray-800 max-w-6xl mb-16">
            <p>
             Every couple has a unique journey, and our décor tells that story through carefully chosen themes and concepts. Whether you envision a royal palace-inspired wedding, a chic modern décor with minimalism, a bohemian outdoor setup, or a fairytale-inspired theme, PS Decor brings your imagination to reality. Our event stylists focus on harmonizing colors, textures, fabrics, floral designs, and lighting effects to set the perfect mood. We also specialize in personalized décor elements such as monogrammed props, thematic stages, and custom floral installations.
              By blending cultural traditions with contemporary styling, we deliver a balance of heritage and luxury that resonates with your family and guests alike.
            </p>
