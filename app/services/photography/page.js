...
const photography = () => {
  return (
    <div className="min-h-screen bg-[#FFF8F0] text-[#4A3728]">
      ...
      Capture Your Special Moments in Cinematic Detail
          </p>
        </div>
      </section>
      ...
      <div className="bg-[#FFF1E0] py-6">
        <div className="max-w-7xl mx-auto px-6 text-[13px] text-gray-600 flex gap-2">
          ...
          <span>{'>'}</span> 
          <span className="font-semibold text-[#4A3728]">Photography & Cinematic Films</span>
        </div>
      </div>
      ...
      <section className="max-w-7xl mx-auto px-6 py-12 md:py-20">
        <h2 className="text-3xl md:text-5xl font-serif mb-4 text-[#4A3728]">
            Photography & Cinematic Films – PS Decor
        </h2>
      ...
      <section className="bg-[#fceee5]/50 py-20 border-t border-b border-orange-100/50">
        <div className="max-w-7xl mx-auto px-6">
         ...
         Wedding Photography Tailored to Your Story
          </h2>
          ...
          Cinematic Wedding Films with a Personal Touch
            </h2>
         ...
         <div className="mt-20">
            <h2 className="text-3xl md:text-4xl font-serif mb-8 text-[#4A3728]">
             Pre-Wedding Shoots & Creative Concepts
            </h2>
            <p className="text-lg text-gray-800 leading-relaxed max-w-6xl mb-12">
          ...
          <div className="mt-20">
            <h2 className="text-3xl md:text-4xl font-serif mb-8 text-[#4A3728]">
          Why Choose PS Decor for Wedding Photography & Films
            </h2>
            <p className="text-lg text-gray-800 leading-relaxed max-w-6xl mb-12">
